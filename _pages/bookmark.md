...
[GC Frauen](webcal://p103-caldav.icloud.com/published/2/MjA1MjQ3NjAwNDAyMDUyNJHuBm4JvFsW9O5xhZKJaN-87aFlmgc0vDO604UvDuyAy3c-zI8QCUuSGAeCUhDy4xcZf_s_juN2Q9Qdqd_aHLc): Fixture of [Grasshopper Zürich women's football](https://gcfrauenfussball.ch/), and some games of Chinese women's football team.  
\
Calendars are usually updated on every Friday afternoon (Central Europe Time, UTC+1:00) for next week.  
...
However, after graduation, Adobe softwares are no longer available for free. Therefore I switched to open-sourced [kdenlive](https://kdenlive.org/en/) in 2021. But I was not too accoustomed to kdenlive, so after I saw a recommendation of [DaVinci Resolve](https://www.blackmagicdesign.com/products/davinciresolve) from [Mediastorm](https://space.bilibili.com/946974), I immediately started to use DaVinci Resolve. The free version of DaVinci Resolve already offers more than enough functions for me. So I believe I will continue using it for a long time.  
...
I use (at least from now on) open-sourced fonts [Noto](https://fonts.google.com/noto) for my subtitiles.  




### Some tools in my bookmarks
